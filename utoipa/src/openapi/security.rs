...
impl OAuth2 {
    ...
    ///
    /// The metadata URL points to an [OAuth 2.0 Authorization Server Metadata][rfc8414]
    /// document that describes the endpoints, supported flows and other configuration of the
    /// authorization server. This is an OpenAPI 3.2 addition.
    ///
...
///
/// The device authorization flow (also known as the "device flow") is defined by
/// [RFC 8628][rfc8628] and lets input-constrained devices (smart TVs, CLIs, IoT devices) obtain
/// access tokens by directing the user to complete authorization on a secondary device, such as
/// a phone or a computer. Support for this flow was added to the OpenAPI specification in 3.2.
///
